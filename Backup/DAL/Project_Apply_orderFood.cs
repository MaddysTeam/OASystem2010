...
namespace Dianda.DAL
{
	...
	public class Project_Apply_orderFood
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "Project_Apply_orderFood"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from Project_Apply_orderFood");
		...
		public void Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Project_Apply_orderFood ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
			parameters[0].Value = ID;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,ApplyID,UserDatetime,OrderNum ");
			strSql.Append(" FROM Project_Apply_orderFood ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,ApplyID,UserDatetime,OrderNum ");
			strSql.Append(" FROM Project_Apply_orderFood ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Project_Apply_orderFood";
