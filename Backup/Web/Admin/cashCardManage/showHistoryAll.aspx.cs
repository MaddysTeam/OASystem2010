    ...
    public partial class showHistoryAll : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (Request["PageRole"] != null)
                    PageRole = Request["PageRole"].ToString();

                if (Request["snm"] != null)
                    snm = Request["snm"].ToString();

                this.txtXK.Text = snm;

                if (Request["nowPaging"] != null)
                    nowPaging = Request["nowPaging"].ToString();
        ...
        protected void BindData()
        {
            try
            {
                ...
                sqlAll += " (max(case a.DetailName when '讲课费' then a.Balance else 0 end)+ ";
                ...
                sqlAll += " (max(case a.DetailName when '讲课费' then a.Oldbalance else 0 end)+ ";
	            ...
	            sTable +=" (max(case a.DetailName when '讲课费' then a.Balance else 0 end)+ ";
	            ...
	            sTable +=" (max(case a.DetailName when '讲课费' then a.Oldbalance else 0 end)+  ";
                ...
                if (!string.IsNullOrEmpty(snm))
                {
                    sTable += " where a.CardName like '%" + snm + "%' ";
                }
        ...
        protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow) 
                {
                    ...
                    {
                        DataTable DT = new DataTable();
                        string strSQL = "Select * From vCash_Apply_History Where CashCertificateID=" + drv.Row["CardID"].ToString();
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            sql += " (max(case a.DetailName when '讲课费' then a.Balance else 0 end)+ ";
            ...
            sql += " (max(case a.DetailName when '讲课费' then a.Oldbalance else 0 end)+  ";
