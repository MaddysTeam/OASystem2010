<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucmanage.ascx.cs" Inherits="Dianda.Web.Admin.personalProjectManage.OANews.ucmanage" %>
...
<table cellpadding="0" cellspacing="0" width="100%" height="100%">
    <tr>
        <td valign="top">
            <table align="center" bgcolor="#99cccd" cellpadding="0" cellspacing="0" width="90%">
                <tr>
                    <td height="3px">
                    </td>
                </tr>
                                                                        ...
                                                                        <table class="tab2">
                                                                            <tr>
                                                                                <td style="width: 80px;">
                                                                                 ...
                                                                                 <%--   <asp:RadioButton ID="RadioButton1" runat="server" Text="收件箱" AutoPostBack="True"
                                                                                        OnCheckedChanged="RadioButton1_CheckedChanged" />--%>
                                                                                </td>
                                                                                <td style="width: 740px;">
                                                                                    <%--<asp:RadioButton ID="RadioButton2" runat="server" Text="发件箱" AutoPostBack="True"
