...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr><td height="3px"></td></tr>
       ...
       <tr><td>
          <table class="tab1" cellpadding="0" cellspacing="0"><tr><td class="tab1_td1">&nbsp;</td><td class="tab1_td2"><asp:Label ID="LB_NAME1" runat="server" Text="Label" CssClass="LB_name1"></asp:Label>管理 >>编辑<asp:Label ID="LB_NAME2" runat="server" Text="Label" CssClass="LB_name1"></asp:Label>
          </td></tr></table>  
          </td></tr>
      <tr><td>
...
display="Dynamic" /></td>
    ...
    <td style="padding-left:300px; padding-top:10px">
      <asp:Button ID="Button_sumbit" runat="server" ValidationGroup="add"  Text=" 确定 " OnClick="Button_queding_Click" CssClass="button1" />　<asp:Button ID="Button_goback" runat="server" Text="返回" OnClick="Button_goback_Click" CssClass="button1" />
    </td>
    </tr></table>
