...
namespace Dianda.COMMON
{
    public class CookiesHelper
    {
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public  string GetCookieValue(HttpCookie cookie, string key)
        {
            if (cookie != null)
            {
        ...
        /// <param name="cookieName"></param>
        /// <param name="expires"></param>
        public  void SetCookie(string cookieName, DateTime expires)
        {
        ...
        /// <param name="value"></param>
        /// <param name="expires"></param>
        public  void AddCookie(string key, string value, DateTime expires)
        {
        ...
        /// <param name="key"></param>
        /// <param name="value"></param>
        public  void AddCookie(string cookieName,string key, string value)
        {
        ...
        public  void AddCookie(string cookieName, DateTime expires)
        {
            HttpCookie cookie = new HttpCookie(cookieName);
            cookie.Expires = expires;
            AddCookie(cookie);
        ...
        /// <param name="value"></param>
        /// <param name="expires"></param>
        public  void AddCookie(string cookieName, string key, string value, DateTime expires)
        {
            HttpCookie cookie = new HttpCookie(cookieName);
            cookie.Expires = expires;
            cookie.Values.Add(key, value);
