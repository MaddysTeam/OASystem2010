<%@ Page Language="C#" AutoEventWireup="true"   MasterPageFile="~/Admin/ajaxAdmin_noSession.Master"  CodeBehind="delshou.aspx.cs" Inherits="Dianda.Web.Admin.DOC_transport.delshou" %>
        ...
        <tr bgcolor="#d4f6d9">
            <td>
                <table height="30px" bgcolor="#ffffff" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td> &nbsp;&nbsp;<img alt="" src="../images/2009-3-23/gif_46_067.gif" /> &nbsp;&nbsp; <span class="titlePosition">公文流转收件箱文件>>删除</span>&nbsp;&nbsp; 
