<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/OAmaster.Master" AutoEventWireup="true" CodeBehind="modifyFolder.aspx.cs" Inherits="Dianda.Web.Admin.DocumentManage.modifyFolder" %>
  ...
  <tr><td colspan="2" height="50"></td></tr>
      ...
      <%--   <tr>
            ...
            <td align="center" colspan="2"> <asp:Button ID="Button_sumbit" runat="server" 
                    ...
                    />&nbsp;<asp:Label ID="Label_notice" runat="server" ForeColor="Red" Text=""></asp:Label></td>
            </tr>
             <tr><td colspan="2" height="70"></td></tr></table></td></tr></table></td></tr></table>
             </td></tr>
