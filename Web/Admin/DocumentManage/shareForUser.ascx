<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="shareForUser.ascx.cs"
    Inherits="Dianda.Web.Admin.DocumentManage.shareForUser" %>
                    ...
                    <tr bgcolor="#f0f0f0" height="40px">
                        <td align="center">
                            <table cellpadding="0" cellspacing="0" width="90%">
                                <tr>
                                    <td align="left">
                                        <asp:CheckBoxList ID="CheckBoxList_userlist" TabIndex="<%# Container.DataItemIndex%>" OnSelectedIndexChanged="user_CheckedChanged"  runat="server" RepeatColumns="4" AutoPostBack="true">
                                        </asp:CheckBoxList>
