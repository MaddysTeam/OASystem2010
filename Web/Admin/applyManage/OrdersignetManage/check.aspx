<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/OAmaster.Master" AutoEventWireup="true" CodeBehind="check.aspx.cs" Inherits="Dianda.Web.Admin.applyManage.OrdersignetManage.check" %>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tab_height2">
  ...
  <tr>
    ...
    <td>印章类型：<asp:Label ID="Label_SignetName" runat="server" Text=""></asp:Label></td>
  </tr>
  <tr>
      ...
      <td>印章份数：<asp:Label ID="Label_SignetNums" runat="server" Text=""></asp:Label></td>
  </tr>
  <tr>
  ...
  <tr>
    <td  colspan="3">
        ...
        <tr>
            ...
            <td align="left"><asp:RadioButtonList ID="RadioButtonList_Check" runat="server" RepeatColumns="3">
