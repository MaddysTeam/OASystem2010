		...
		protected void Page_Load(object sender, EventArgs e)
		{
			if (!IsPostBack)
			{
				...
				if (null != Request["role"] && Request["role"].ToString().Equals("manager"))
				{
					...
					/*设置模板页中的管理值*/
					(Master.FindControl("Label_navigation") as Label).Text = "经费 > 待办预算查询 > 待办预算明细";
					/*设置模板页中的管理值*/
				}
				else
				{
					...
					/*设置模板页中的管理值*/
					(Master.FindControl("Label_navigation") as Label).Text = "管理 > 财务管理 > 待办预算管理 > 待办预算明细";
					/*设置模板页中的管理值*/
				}
