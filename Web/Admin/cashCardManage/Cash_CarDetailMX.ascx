<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Cash_CarDetailMX.ascx.cs"
    Inherits="Dianda.Web.Admin.cashCardManage.Cash_CarDetailMX" %>
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
        <td>
            资金卡细目：&nbsp;&nbsp;<input type="button" id="btn_create" value="+" class="" onclick="AddRow()" />&nbsp;&nbsp;<label
