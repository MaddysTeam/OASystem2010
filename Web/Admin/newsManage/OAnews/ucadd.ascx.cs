    ...
    public partial class ucadd : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
				...
				if(null!= Session["editorContent"])
				{
					hid.Value = Session["editorContent"].ToString();
				}
        ...
        private void GetrblLimitsChoose()
        {
            ...
            else if (_foritems == "PROJECT")//[项目]项目组成员
            {
				...
				li.Attributes.Add("onclick", "alert(2);");
                li.Selected = true;
                this.rblLimitsChoose.Items.Add(li);
            }
            else if (_foritems == "DEPARTMENT")//[部门]本部门成员
            {
				ListItem li = new ListItem("本部门成员", "1");
				li.Attributes.Add("onclick", "alert(3);");
                li.Selected = true;
                this.rblLimitsChoose.Items.Add(li);
            }
        }
        ...
        protected void Button_sumbit_Click(object sender, EventArgs e)
        {
            try
            {
				...
				mNews_News.CONTENTS = hid.Value; // this.FCKeditor_neirong.Value;
                // mNews_News.TYPE = 0;
        ...
        protected void rblLimitsChoose_SelectedIndexChanged(object sender, EventArgs e)
        {
			...
			Session["editorContent"] = hid.Value; 
			BindDataList();
        }
    }
}