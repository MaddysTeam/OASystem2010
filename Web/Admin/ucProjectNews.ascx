<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucProjectNews.ascx.cs"
    Inherits="Dianda.Web.Admin.ucProjectNews" %>
<div>
                    ...
                    <tr>
                        <td valign="top">
                            <table cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td valign="top" style="background-image: url(/Admin/images/OAimages/blue_line.jpg);
                                        height: 12px;">
                                    </td>
                                </tr>
                                <tr>
                                                                                    ...
                                                                                    <asp:TemplateField>
                                                                                        <ItemTemplate>
                                                                                            <table width="100%" style="border-width: 1px; border-color: #808080; border-bottom-style: dashed;">
                                                                                                <tr onmouseover="this.childNodes.item(1).style.display='block'" onmouseout="this.childNodes.item(1).style.display='none'">
                                                                                                    <td valign="top" style="width: 80%">
                                                                                                        <asp:Label ID="lblURLS" runat="server" Text=""></asp:Label>
                                                                                                    </td>
                                                                                                    <td valign="top" align="right" style="display: none">
                                                                                                        <asp:LinkButton ID="btnApply" runat="server" CommandArgument='<%#Eval("ID")%>' OnClick="btnApply_Click">业务申请</asp:LinkButton>
                                                                                                        <asp:LinkButton ID="btnDoc" runat="server" CommandArgument='<%#Eval("ID")%>' OnClick="btnDoc_Click">项目文档</asp:LinkButton>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </ItemTemplate>
