<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Admin/ajaxAdmin_noSession.Master"  CodeBehind="manage.aspx.cs" Inherits="Dianda.Web.Admin.DOC_transport.manage" %>

<%@ Register src="docFromModel.ascx" tagname="docFromModel" tagprefix="uc1" %>
        ...
        <tr bgcolor="#ffffff">
            <td>
                    ...
                    <tr bgcolor="#d4f6d9">
                        <td>
                            <table height="30px" bgcolor="#ffffff" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td>
                                        &nbsp;&nbsp;<img alt="" src="../images/2009-3-23/gif_46_067.gif" /> &nbsp;&nbsp; <span class="titlePosition">以下是公文流转发件箱文件列表</span>&nbsp;&nbsp; <input id="Button1" onclick="window.open('add.aspx','_self')" type="button"
                                         ...
                                         <input id="Button_addNeworgan" onclick="window.open('http://totalonline.shtvsss.com/Default.aspx?user=<%=Session["USERID_SYSUSER"].ToString()%>','_blank')" type="button"
                                            ...
                                            onmouseout="this.className='btn1_mouseout'" />
                                              <input id="Button2" onclick="window.open('manageShou.aspx','_self')" type="button"
                                            value="-进入收件箱-" class="btn1_mouseout" onmouseover="this.className='btn1_mouseover'"
                                            onmouseout="this.className='btn1_mouseout'" />
                                    </td>
                                </tr>
                                <tr>
                ...
                <table height="40px" align="center" bgcolor="#ffffff" cellpadding="0" cellspacing="0"
                    ...
                    <tr bgcolor="#ffffff">
                        <td valign="top">
                          <uc1:docFromModel ID="docFromModel1" runat="server" />
                        </td>
                    </tr>
                </table>
            </td>
