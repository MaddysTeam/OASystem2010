<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/OAmaster.Master" AutoEventWireup="true" CodeBehind="shareFolder.aspx.cs" Inherits="Dianda.Web.Admin.DocumentManage.shareFolder" %>
      ...
      <table cellpadding="3" bgcolor="#ffffff" cellspacing="3" width="80%" align="center">
          <tr>
            <td align="center" colspan="2"> <asp:Button ID="Button_sumbit" runat="server" 
             ...
             <tr><td colspan="2" height="20"></td></tr></table>
