<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/OAmaster.Master" AutoEventWireup="true"
    CodeBehind="manage.aspx.cs" Inherits="Dianda.Web.Admin.applyManage.OrderfoodManage.manage" %>
                        ...
                        <table align="center" bgcolor="#99cccd" cellpadding="0" cellspacing="0" width="98%">
                                                                                ...
                                                                                <td>
                                                                                    <table class="tab2" >
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                预订日期：<input class="Inputtext" id="TB_ordertime" runat="server" width="200" type="text"
                                                                                            ...
                                                                                            <td width="70px" runat="server" id="td_w">&nbsp;</td>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td valign="top" align="center">
                                                                                                <asp:GridView ID="GridView1" AutoGenerateColumns="False" OnRowDataBound="GridView1_RowDataBound"
                                                                                                    runat="server" CssClass="GridView1" PageSize="10">
                                                                                                    <Columns>
                                                                                                        ...
                                                                                                        <asp:BoundField HeaderText="预订日期" DataField="UserDatetime" DataFormatString="{0:yyyy-MM-dd}">
                           ...
                           <ItemTemplate>
                            ...
                            <ItemStyle HorizontalAlign="Center" CssClass="ItemStyle1"  />
                                                                                                        ...
                                                                                                        <asp:BoundField HeaderText="预订份数" DataField="OrderNum">
                                                                                                            <HeaderStyle HorizontalAlign="Center" CssClass="HeaderStyle3" />
                                                                                                            <ItemStyle HorizontalAlign="Center" CssClass="ItemStyle1" />
                                                                                                        </asp:BoundField>
