<%@ Page Language="C#" MasterPageFile="~/Admin/OAmaster.Master" AutoEventWireup="true" CodeBehind="add.aspx.cs" Inherits="Dianda.Web.Admin.budgetManage.todo.add" %>
																					...
																					<tr>
																						...
																						<td>
																							<asp:TextBox ID="TB_BudgetName" runat="server" Width="200"></asp:TextBox>&nbsp;&nbsp;<asp:RequiredFieldValidator
																								...
																								ErrorMessage="待办预算名称不能为空!" Display="Dynamic" />
																						</td>
																					</tr>
																					<tr>
																						<td align="right">所属部门：
