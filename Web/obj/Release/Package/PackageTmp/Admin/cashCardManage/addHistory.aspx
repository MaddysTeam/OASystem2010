<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/OAmaster.Master" AutoEventWireup="true"
    CodeBehind="addHistory.aspx.cs" Inherits="Dianda.Web.Admin.cashCardManage.addHistory" %>
                                                ...
                                                <td colspan="2">
                                                    <table class="tab1" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td class="tab1_td2">
                                                                <asp:Label ID="LB_name" runat="server" Text="" CssClass="LB_name1"></asp:Label>资金卡记账
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
