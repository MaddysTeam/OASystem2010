<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/OAmaster.Master" CodeBehind="resourceManage.aspx.cs" Inherits="Dianda.Web.Admin.personalProjectManage.OAapply.resourceManage" %>
                        ...
                        <td>
                            <table  cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    ...
                                    <table class="tab2">
                                    <tr>
                                    <td><%--按项目筛选：<asp:DropDownList ID="DDL_project" runat="server" AutoPostBack = "true" OnSelectedIndexChanged="DDL_project_Change">
                                        </asp:DropDownList>&nbsp;&nbsp;&nbsp;&nbsp;--%>
                                    按类型筛选：<asp:DropDownList ID="DDL_type" runat="server" AutoPostBack = "true" OnSelectedIndexChanged="DDL_type_Change">
...
<%--                             <asp:BoundField HeaderText="申请类型" DataField="" >
                               ...
                               <asp:BoundField HeaderText="申请人" DataField="SendUserID" >
                                      <HeaderStyle HorizontalAlign="Center"  CssClass="HeaderStyle1" />
                                        <ItemStyle HorizontalAlign="Center" CssClass="ItemStyle1" />
                                </asp:BoundField>--%>
