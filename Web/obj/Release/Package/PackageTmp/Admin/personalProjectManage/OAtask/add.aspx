                                                ...
                                                <table class="tab5">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 717px">
                                                            ...
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="Server" ControlToValidate="TB_StartTime"
                                                                ValidationGroup="add4" ErrorMessage="开始时间不能为空!" Display="Dynamic" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    <td colspan="2" style="height:10px;"></td>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td >
                                                            <asp:CheckBox ID="CheckBox_choose" style="float:left; line-height:20px;vertical-align:middle" Height="26px" runat="server" Text="全部" OnCheckedChanged="CheckBox_choose_CheckedChanged"
                                                                AutoPostBack="true" />
